...
{
    public NPCTankController TankController;
    ...
    private void OnClickAddNode(Vector2 mousePosition)
    {
        ...
        nodes.Add(new Node(mousePosition, 200, 50, nodeStyle, selectedNodeStyle, inPointStyle, outPointStyle,
            OnClickInPoint, OnClickOutPoint, OnClickRemoveNode, OnStateAdd, OnStateRemove));
    }
    ...
    private void OnStateAdd(FSMState state)
    {
        TankController.AddFSMState(state);
    }

    private void OnStateRemove(FSMState state)
    {
        TankController.DeleteState(state.ID);
    }
